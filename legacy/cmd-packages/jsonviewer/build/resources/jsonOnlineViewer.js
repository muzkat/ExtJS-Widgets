...
Ext.onReady(function () {
    ...
    var d = function () {
        var a = Ext.getCmp("edit"), b = Ext.getCmp("tree"), e = b.getRootNode(), p = Ext.getCmp("grid"), k = Ext.getCmp("searchTextField"), n = Ext.getCmp("searchResultLabel"), l = {}, o = null, m = null, f = null, j = null;
        return {
            check: function () {
                var h =
                    a.getValue().replace(/\n/g, " ").replace(/\r/g, " ");
